          ...
          <Row className="py-4">
            ...
            <Col md={6}>
              ...
              <Row>
                ...
                <Col md={6}>
                  <a href="mailto:avishinde1729@gmail.com" className='contactbtn'>Contact</a>
                </Col>
              </Row>
              <Row>
                <ul className='icons'>
                  <a href="mailto:avishinde1729@gmail.com"><MailIcon></MailIcon></a>
                  <a href="https://github.com/Avishkar1729"><GitHubIcon></GitHubIcon></a>
                  <a href='#'><CodeIcon></CodeIcon></a>
                  <a href="https://www.linkedin.com/in/avishkar-shinde-baa112220"><LinkedInIcon></LinkedInIcon></a>
                </ul>
              </Row>
            </Col>
          </Row>
